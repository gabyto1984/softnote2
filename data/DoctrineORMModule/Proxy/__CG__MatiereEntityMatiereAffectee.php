 ...
 */
class MatiereAffectee extends \Matiere\Entity\MatiereAffectee implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'matiere', 'classe', 'evaluations', 'coefficient'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MatiereAffectee $proxy) {
