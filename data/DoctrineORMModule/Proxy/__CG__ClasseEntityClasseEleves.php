 ...
 */
class ClasseEleves extends \Classe\Entity\ClasseEleves implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'classe', 'eleve', 'evaluations'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ClasseEleves $proxy) {
     ...
     * {@inheritDoc}
     */
    public function addEleve(\Eleve\Entity\Eleve $eleve = NULL)
    {
